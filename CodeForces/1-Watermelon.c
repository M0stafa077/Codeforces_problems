...
watermelon in the way they want. For sure, each of them should get a part 
of positive weight.
...
Note
    For example, the boys can divide the watermelon into two parts of 2 and
6 kilos respectively (another variant — two parts of 4 and 4 kilos).
*/
