...
Input
The first line contains a single number n (2 ≤ n ≤ 1000) — the number of 
the tram's stops.
...
At the last stop, all the passengers exit the tram and it becomes empty. More 
formally, No passenger will enter the train at the last stop. That is, bn = 0
...
At the second stop, 2 passengers exit the tram (1 passenger remains inside). Then, 
5 passengers enter the tram. There are 6 passengers inside the tram now.
